...
sealed class NavRoute(val route: String) {
    ...
    object CharScreen: NavRoute("characterScreen")
...
// Один экран для всех героев CharacterScreen(id: String)
...
fun HeroNavHost() {
    ...
    NavHost(navController = navController, startDestination = NavRoute.Main.route) {
        ...
        composable(NavRoute.CharScreen.route, ) { CharacterScreen(navController = navController) }
